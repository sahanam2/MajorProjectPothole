...
//     return imagesList.length == 0? Response(resp:null) : Response(resp: imagesList);
//   }
// }
...
//         uploadData(
//             uid, loc_lat2, loc_lon2, time, loc_pin, current_address,  url,place, 1,survey);
//       }
//       if (check == 1) {
//         var priority = 1;

//         uploadData(uid, loc_lat2, loc_lon2, time, loc_pin, current_address, url,place,
//             priority,survey);
//       }});
//   }
//   getList() async {
...
//       String pincode, String address,String url, Placemark place, var priority, String survey) async {
//     getList();
...
//         ),
//       ),
//       title: Text('Capture Pothole Image'),
//       elevation: 0,
//     );
//   }
...
//                     image:
//                     AssetImage("assets/bgimages/1920.png"),
//                     fit: BoxFit.cover
//                     ),
//               ),
//               //Center(
...
//       }    });
//   }
//   String surveypriority;bool p1,p2,p3;
...
//         children: <Widget>[
//           Text('.'),
//           Text('On what kind of road is this pothole present?',style: TextStyle(fontSize: 19),
//           ),
//           RadioListTile(
//               value: 1,
...
//           ),
//           Text('Where is this pothole located on the road?',    style: TextStyle(fontSize: 19),
//           ),
//           RadioListTile(
//               value: 1,
...
//           ),
//           Text('What is the approximate size of the pothole?',    style: TextStyle(fontSize: 19),
//           ),
//           RadioListTile(
//               value: 1,
